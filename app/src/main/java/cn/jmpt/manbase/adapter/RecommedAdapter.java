...
import cn.jmpt.manbase.adapter.DefaultAdapter;
 ...
 */
public class RecommedAdapter extends DefaultAdapter {
    private List<DaylyDetail.DataEntity> data;

    public RecommedAdapter(List<DaylyDetail.DataEntity> data) {
        super(data);
        this.data = data;
    }

    public void addData(List<DaylyDetail.DataEntity> data) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        DaylyDetail.DataEntity dataEntity = data.get(position);
